=for stopwords
-bhiLtvx aklog AFS OpenSSH PAG HUP ALRM KRB5CCNAME AKLOG kstart afslog
Allbery Bense designator krenew Ctrl-C
...
B<krenew> [B<-bhiLtvx>] [B<-c> I<child pid file>] [B<-H> I<minutes>]
