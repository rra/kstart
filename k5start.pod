=for stopwords
-bFhLnPqstv keytab username kinit LDAP aklog HUP ALRM KRB5CCNAME AFS PAG
init AKLOG kstart krenew afslog Bense Allbery Navid Golpayegani
forwardable proxiable designator
...
B<k5start> [B<-bFhLnPqstv>] [B<-c> I<child pid file>] [B<-f> I<keytab>]
...
B<k5start> B<-U> B<-f> I<keytab> [B<-bFhLnPqstv>] [B<-c> I<child pid file>]
    [B<-g> I<group>] [B<-H> I<minutes>] [B<-I> I<service instance>]
