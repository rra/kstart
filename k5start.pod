...
=for stopwords
-bhnqstv keytab username kinit LDAP aklog HUP KRB5CCNAME AFS PAG init
AKLOG kstart krenew afslog Bense Allbery Navid Golpayegani

=head1 SYNOPSIS

B<k5start> [B<-bhnqstv>] [B<-c> I<child pid file>] [B<-f> I<keytab>]
...
B<k5start> B<-U> B<-f> I<keytab> [B<-bhnqstv>] [B<-c> I<child pid file>]
    [B<-g> I<group>] [B<-H> I<minutes>] [B<-I> I<service instance>]
