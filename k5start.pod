...
If B<-H> is used with B<-K>, the specified remaining lifetime will replace
the default value of two minutes.
...
If B<-K> is used with B<-H>, the specified remaining lifetime will be
ensured instead of the default of two minutes.
