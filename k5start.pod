...
B<k5start> [B<-bhnqstv>] [B<-f> I<keytab>] [B<-g> I<group>]
    [B<-H> I<minutes>] [B<-I> I<service instance>]
...
B<k5start> B<-U> B<-f> I<keytab> [B<-bhnqstv>] [B<-g> I<group>]
    [B<-H> I<minutes>] [B<-I> I<service instance>] [B<-K> I<minutes>]
    [B<-k> I<ticket file>] [B<-l> I<time string>] [B<-m> I<mode>]
    [B<-o> I<owner>] [B<-p> I<pid file>] [B<-r> I<service realm>]
    [B<-S> I<service name>] [I<command> ...]
...
This option may not be used with B<-K> or a specified command since
changing the ownership of the ticket cache will prevent B<k5start> from
re-reading it or renewing it.
...
This option may not be used with B<-K> or a specified command since
changing the permissions of the ticket cache will prevent B<k5start> from
re-reading it or renewing it.
